                ...
                <ul>
                    ...
                    <li>
                        <a href="#blog-card">
                            ...
                            <span class="link"><?=$lang['topmenu_blog']?></span>
                        </a>
                    </li>
                    <li>
...
Profile
            ...
            <div class="profile">
                ...
                <!-- profile buttons -->
                <div class="lnks">
                    <a href="<?=$ROOT ?>/download/download.php?path=cv.pdf" class="lnk">
                ...
                <div class="row border-line-v">
                        ...
                        <div class="box-item">
                            <div class="image">
                                <a href="blog-post-new.html">
                                    <img src="<?=$ROOT ?>images/blog/blog1.jpg" alt="By spite about do of allow" />
                                    <span class="info">
                            ...
                            <div class="desc">
                                ...
                                <a href="blog-post-new.html" class="name">Microservices architecure: service discovery pattern</a>
                                <div class="text">
                                    <p>How to implement a client side service discovery pattern using Netflix Eureka</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-d-6 col-t-6 col-m-12">
                        <div class="box-item">
                            <div class="image">
                                <a href="blog-post-new.html">
                                    <img src="<?=$ROOT ?>images/blog/blog2.jpg" alt="By spite about do of allow" />
                                    <span class="info">
												<span class="ion ion-document-text"></span>
											</span>
                                </a>
                    ...
                    <div class="col col-d-6 col-t-6 col-m-12">
                        <div class="box-item">
                            <div class="image">
                                <a href="blog-post-new.html">
                                    <img src="<?=$ROOT ?>images/blog/blog3.jpg" alt="By spite about do of allow" />
                                    <span class="info">
												<span class="ion ion-document-text"></span>
											</span>
                                </a>
